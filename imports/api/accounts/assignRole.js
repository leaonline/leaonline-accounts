...
export const assignRole = async (
	...
	if (!rolesCount) {
		throw new Meteor.Error('assignRole.failed', 'assignRole.unknownRole', {
			role,
		})
	}
	...
	if (!usersCount) {
		throw new Meteor.Error('assignRole.failed', 'assignRole.unknownUser', {
			userId,
		})
	}
